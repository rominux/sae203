...
**Présentation** +
[.lead]
Ce rapport retrace l'installation, la configuration et l'automatisation d'une machine virtuelle sous #Debian#, ainsi que les réponses aux questions techniques associées.
====
...
_[Insérer ici une capture d'écran du récapitulatif de votre VM dans VirtualBox]_ +
...
. **Sélection des logiciels** : 
  ...
  ** MATE (en prenant soin de décocher GNOME)
  ** Serveur web
  ** Serveur SSH
  ** Utilitaires usuels du système

_[Insérer ici une capture d'écran de l'étape "Sélection des logiciels" ou de votre bureau MATE]_
