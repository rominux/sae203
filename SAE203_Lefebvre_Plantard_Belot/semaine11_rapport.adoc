...
=== 1. Installation du binaire et configuration de l'utilisateur système
...
=== 2. Choix de la base de données et de l'architecture réseau
...
=== 5. Tests d'utilisation approfondis
