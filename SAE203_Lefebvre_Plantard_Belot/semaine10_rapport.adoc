...
=== 3. Comparaison de versions avec git diff
...
=== 4. Gestion des branches et fusions (Merge)
...
=== 7. Travail collaboratif sur GitLab
...
=== 8. Utilisation d'une interface graphique (Ungit)
...
=== 9. Retour d'expérience et difficultés rencontrées
