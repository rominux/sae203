...
* **Systemd** : C'est le gestionnaire de système et de services de Linux. Il permet de démarrer, arrêter et surveiller les processus fonctionnant en arrière-plan (les démons), et de s'assurer qu'ils redémarrent en cas de crash footnote:[https://wiki.debian.org/fr/systemd[Wiki Debian - systemd]].
